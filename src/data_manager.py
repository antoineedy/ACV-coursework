...
class BaseDataManager:
    def __init__(
        ...
        random_translation=False,  # randomly translate the image
        random_horizontal=False,  # randomly flip the image horizontally
        **kwargs,
    ):
        ...
        self.random_horizontal = random_horizontal
        ...
        transform_train, transform_test = build_transforms(
            ...
            random_horizontal=self.random_horizontal,
        )
